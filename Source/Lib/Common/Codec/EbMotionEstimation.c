...
#if FROM_7_TO_4_MV
               picture_control_set_ptr->me_results[sb_index]->me_mv_array[pu_index][((listIndex && sequence_control_set_ptr->static_config.mrp_mode == 0) ? 4 : (listIndex && sequence_control_set_ptr->static_config.mrp_mode == 1) ? 2 : listIndex ? 1 : 0) + ref_pic_index].x_mv = _MVXT(context_ptr->p_sb_best_mv[listIndex][ref_pic_index][nIdx]);
               picture_control_set_ptr->me_results[sb_index]->me_mv_array[pu_index][((listIndex && sequence_control_set_ptr->static_config.mrp_mode == 0) ? 4 : (listIndex && sequence_control_set_ptr->static_config.mrp_mode == 1) ? 2 : listIndex ? 1 : 0) + ref_pic_index].y_mv = _MVYT(context_ptr->p_sb_best_mv[listIndex][ref_pic_index][nIdx]);
#else
